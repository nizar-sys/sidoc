...
<li class="nav-item">
    <a class="nav-link {{ $routeActive == 'documents.index' ? 'active' : '' }}" href="{{ route('documents.index') }}">
        <i class="fas fa-book text-default"></i>
        <span class="nav-link-text">Documents</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link {{ $routeActive == 'documents-details.index' ? 'active' : '' }}" href="{{ route('documents-details.index') }}">
        <i class="fas fa-book text-danger"></i>
        <span class="nav-link-text">Document Detail</span>
    </a>
</li>
<li class="nav-item">
